...
public class XxlJobExecutor {
      ...
      for (Map.Entry<Integer, JobThread> item : jobThreadRepository.entrySet()) {
        ...
        if (oldJobThread != null) {
          try {
            ...
            log.error(">>>>>>>>>>> xxl-job, JobThread destroy(join) error, jobId:{}", item.getKey(),
                e);
  ...
  private void initEmbedServer(String address, String ip, int port, String appName,
      String accessToken) throws BindException {
  ...
  public static void registryJobHandler(String name, IJobHandler jobHandler) {
    log.info(">>>>>>>>>>> xxl-job register jobhandler success, name:{}, jobHandler:{}", name,
        jobHandler);
  ...
  public static JobThread registerJobThread(int jobId, IJobHandler handler,
    ...
    newJobThread.start();
    log.info(">>>>>>>>>>> xxl-job regist JobThread success, jobId:{}, handler:{}",
