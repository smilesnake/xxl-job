...
import com.xxl.job.core.biz.model.remote.IdleBeatParam;
    ...
    public ReturnT<String> route(TriggerParam triggerParam, List<String> addressList) {
        ...
        for (String address : addressList) {
            ...
            try {
                ...
                idleBeatResult = Objects.requireNonNull(executorBiz).idleBeat(new IdleBeatParam(triggerParam.getJobId()));
            } catch (Exception e) {
                log.error(e.getMessage(), e);
                idleBeatResult = new ReturnT<>(ReturnT.FAIL_CODE, "" + e);
            }
            idleBeatResultBuild.append((idleBeatResultBuild.length() > 0) ? "<br><br>" : "").append(I18nUtil.getString("jobconf_idleBeat")).append("：")
